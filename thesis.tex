...
\begin{tét}
Legyen $G$ egy összefüggő gráf és $F$ egy feszítőfája. Ekkor létezik egy olyan $A$ mátrix, amelynek az oszlopai $A_G$ oszlopainak olyan lineáris kombinációi, hogy $\mathrm{per}(A) \neq 0$, $\eta_A(v) \leq 1$ $\forall v \in V$, $\eta_A(e) = 0$ $\forall e \in E(F)$ és $\eta_A \leq 2$ $\forall e \in E \smallsetminus E(F)$.
\end{tét}
...
Legyen $u$ egy olyan csúcsa $G$-nek, amely levél $F$-ben. Legyen továbbá $N(u) = \lbrace u_1, u_2, \ldots, u_k \rbrace$ valamint $e_i = uu_i$, $1 \leq i \leq k$. Hagyjuk el az $u$ csúcsot $G$-ből, és jelöljük az így kapott gráfot $G'$-vel. A feltevésünk miatt $G'$-nek létezik olyan $\eta'$ érvényes indexfüggvénye, melyre $\mathrm{per}(A_{G'}(\eta')) \neq 0$, $\eta'(v) \leq 1$ minden $v \in V(G')$-re, $\eta'(e) \leq 2$ minden $e \in E(G')$-re és $\eta(e) = 0$ minden $e \in E(F - u)$-ra.
...
Figyeljük meg, hogy $M_{k - 1} = A_G(\tau)$ minden olyan $\tau$ indexfüggvényére $G$-nek, amelyre
\begin{itemize}
